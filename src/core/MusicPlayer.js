...
/**
 * Music Player with Popup UI
 * Each page has a designated song that plays in sync across pages
 * Version: 3.0.0 - Now extends AudioManager
 */
...
class MusicPlayer extends AudioManager {
    ...
    /**
     * Extended initialization specific to MusicPlayer
     */
        ...
        popup.innerHTML = `
            <div class="popup-content">
                <div class="popup-header">
                    <h3>🎵 Now Playing</h3>
                    <button class="popup-close-btn" onclick="window.musicPlayer.togglePopup()">×</button>
                </div>
                <div class="song-info">
                ...
                <div class="music-controls">
                    <button class="popup-play-pause-btn" onclick="window.musicPlayer.toggle()">▶️</button>
                </div>
                <div class="volume-control">
                    <span class="volume-icon" onclick="window.musicPlayer.toggleMute()" title="Click to mute/unmute">🔊</span>
                    <input type="range" class="volume-slider" min="0" max="100" value="${this.volume * 100}"
                           oninput="window.musicPlayer.setVolume(this.value / 100)" title="Adjust volume">
                </div>
                <div class="progress-container">
                    <div class="progress-bar" onclick="window.musicPlayer.seekTo(event)">
