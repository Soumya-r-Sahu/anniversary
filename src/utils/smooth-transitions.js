...
class SmoothTransitions {
  ...
  enhanceCards() {
    const cards = document.querySelectorAll(
      ".card, .timeline-content, .memory-card, .love-letter",
    );
    cards.forEach((card) => {
  ...
  enhanceGalleryItems() {
    const galleryItems = document.querySelectorAll(
      ".gallery-slide, .photo-card, .filter-btn",
    );
  ...
  enhanceMemoryCards() {
    const memoryCards = document.querySelectorAll(
      ".memory-card, .anniversary-memory",
    );
  ...
  animatePageEntrance() {
    ...
    const sections = document.querySelectorAll(
      "section, .hero, .main-content, header",
    );
  ...
  enhanceCountdown() {
    const countdownElements = document.querySelectorAll(
      ".countdown-number, .countdown-container, .countdown-item",
    );
