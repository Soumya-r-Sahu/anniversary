...
class PhotoGalleryPage {
  ...
  initializeLightbox() {
    const photos = document.querySelectorAll(
      ".gallery-photo, .photo-item, .lightbox-trigger",
    );
  ...
  openLightbox(photo) {
    ...
    const index = Array.from(
      document.querySelectorAll(".gallery-photo, .photo-item"),
    ).indexOf(photo);
  ...
  createLightbox(src, caption, index) {
    ...
    lightbox
      ...
      .addEventListener("click", () => this.lightboxPrevious());
    lightbox
      .querySelector(".lightbox-next")
      .addEventListener("click", () => this.lightboxNext());
   ...
   */
  initializeSlideshow() {
    const slideshowBtn = document.querySelector(
      ".slideshow-btn, .play-slideshow",
    );
  ...
  initializeMemoryLane() {
    const memoryLane = document.querySelector(
      "#memory-lane-controller, .memory-lane",
    );
  ...
  initializeLazyLoading() {
    ...
    const photos = document.querySelectorAll(
      "img[data-src], .gallery-photo[data-src]",
    );
