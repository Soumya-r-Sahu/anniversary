...
class LoveStoryPageController {
            ...
            this.chapters = [
                {
                    ...
                    title: "First Meeting",
                    date: "2023-01-15",
                    content: "The day our eyes first met, and the world suddenly made sense.",
                ...
                },
                {
                    ...
                    title: "First Date",
                    date: "2023-01-22",
                    content: "Nervous butterflies, endless conversations, and the beginning of forever.",
                ...
                },
                {
                    ...
                    title: "First Kiss",
                    date: "2023-02-14",
                    content: "Under the stars, time stopped as our hearts found their rhythm together.",
                ...
                },
                {
                    ...
                    title: "The Proposal",
                    date: "2024-02-14",
                    content: "Forever started with a simple question and a resounding yes.",
    ...
    async initializeComponents() {
        ...
        // Initialize heart animation with story-specific patterns
        ...
        const observer = new IntersectionObserver((entries) => {
            entries.forEach(entry => {
                if (entry.isIntersecting) {
                    ...
                    this.updateHeartAnimation(chapterElement.dataset.mood);
                }
            });
        }, observerOptions);
    ...
    activateChapter(index) {
        ...
        console.log(`📖 Activating chapter ${index + 1}: ${this.chapters[index].title}`);
    ...
    updateHeartAnimation(mood) {
        if (!this.heartAnimation) return;
        
        const moodConfigs = {
            'excitement': { pattern: 'burst', intensity: 'high', color: '#ff6b9d' },
            'nervous-excitement': { pattern: 'flutter', intensity: 'medium', color: '#ffa8e1' },
            'magical': { pattern: 'swirl', intensity: 'high', color: '#9c27b0' },
            'joy': { pattern: 'celebration', intensity: 'high', color: '#ff5722' },
            'overwhelming-love': { pattern: 'explosion', intensity: 'maximum', color: '#e91e63' }
        };
        
        const config = moodConfigs[mood] || moodConfigs['joy'];
        this.heartAnimation.updatePattern(config);
    }
    ...
    triggerChapterAnimation(index) {
        ...
        // Animate chapter hearts
        const heartsContainer = chapterElement.querySelector('.chapter-hearts');
        if (heartsContainer && this.heartAnimation) {
            this.heartAnimation.burst(10, heartsContainer);
        }
    ...
    toggleAutoPlay() {
        ...
        if (button) {
            ...
            button.textContent = this.isAutoPlaying ? '⏸️ Pause Story' : '▶️ Play Story';
        }
    ...
    startAutoPlay() {
        ...
        const speed = parseInt(document.querySelector('.auto-play-speed')?.value || 5000);
    ...
    playChapterMusic(musicFile) {
        if (this.musicManager) {
            ...
            const playingButton = document.querySelector(`[data-music="${musicFile}"]`);
            if (playingButton) {
    ...
    enableStoryEditing() {
        ...
        document.querySelectorAll('.chapter-title, .chapter-description').forEach(element => {
    ...
    showStoryComplete() {
        ...
        completionMessage.querySelector('.restart-story').addEventListener('click', () => {
            this.goToChapter(0);
            completionMessage.remove();
        });
        
        completionMessage.querySelector('.continue-journey').addEventListener('click', () => {
            window.location.href = 'anniversary.html';
        });
        
        // Trigger celebration
        this.heartAnimation?.burst(30);
    }
