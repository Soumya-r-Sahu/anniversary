...
class UnifiedBubbleAnimation {
    ...
    onDocumentClick(event) {
        ...
        this.createBubbleBurst(event.clientX, event.clientY, this.getBurstIntensity());
    }

    onDocumentTouch(event) {
        if (event.touches && event.touches[0] && !this.isInteractiveElement(event.target)) {
            const touch = event.touches[0] || event.changedTouches[0];
            this.createBubbleBurst(touch.clientX, touch.clientY, this.getBurstIntensity());
        }
    }
    ...
    getBubbleColorsByPage() {
        const baseColors = [
            {
                gradient: 'radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.8), rgba(236, 72, 153, 0.6), rgba(147, 51, 234, 0.4))',
                border: '1px solid rgba(255, 255, 255, 0.3)',
                shadow: 'inset 0 0 20px rgba(255, 255, 255, 0.5), 0 0 20px rgba(236, 72, 153, 0.3)'
            },
            {
                gradient: 'radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.9), rgba(59, 130, 246, 0.6), rgba(99, 102, 241, 0.4))',
                border: '1px solid rgba(255, 255, 255, 0.3)',
                shadow: 'inset 0 0 20px rgba(255, 255, 255, 0.5), 0 0 20px rgba(59, 130, 246, 0.3)'
            },
            {
                gradient: 'radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.8), rgba(16, 185, 129, 0.6), rgba(5, 150, 105, 0.4))',
                border: '1px solid rgba(255, 255, 255, 0.3)',
                shadow: 'inset 0 0 20px rgba(255, 255, 255, 0.5), 0 0 20px rgba(16, 185, 129, 0.3)'
            }
        ];
        ...
        switch (this.config.pageType) {
            case 'countdown':
                return [...baseColors, {
                    gradient: 'radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.8), rgba(251, 191, 36, 0.6), rgba(245, 158, 11, 0.4))',
                    border: '1px solid rgba(255, 255, 255, 0.3)',
                    shadow: 'inset 0 0 20px rgba(255, 255, 255, 0.5), 0 0 20px rgba(251, 191, 36, 0.3)'
                }];
            case 'anniversary':
                return [...baseColors, {
                    gradient: 'radial-gradient(circle at 30% 30%, rgba(255, 255, 255, 0.8), rgba(244, 63, 94, 0.6), rgba(225, 29, 72, 0.4))',
                    border: '1px solid rgba(255, 255, 255, 0.3)',
                    shadow: 'inset 0 0 20px rgba(255, 255, 255, 0.5), 0 0 20px rgba(244, 63, 94, 0.3)'
                }];
            default:
                return baseColors;
        }
    ...
    cleanupExpiredBubbles() {
        const bubbles = document.querySelectorAll('.bubble-floating, .bubble-random, .bubble-burst');
        let cleaned = 0;
